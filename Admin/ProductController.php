...
class ProductController extends Controller
{
    ...
    {      
        if (isset($request->sort) && $request->sort !=0) {
            if ($request->sort == 1) {
                ...
                $products =  Product::select()->orderBy('avg_rate', 'desc')
                ->paginate(12)->appends('sort', $request->sort);          
            }           
        } else {
    ...
    public function update(ProductRequest $request, $id)
    {
        ...
        return view('admin.product.edit', compact('brands', 'categoris', 'warranty_periods', 'product'))
    ...
    public function createAtt(Request $request, $id)
    {
        ...
        return redirect('admin/san-pham/xem-thong-so-ky-thuat/'.$id)
    ...
    public function updateAtt(ProductAtributeRequest $request,$id)
    {
        ...
        return redirect('admin/san-pham/sua-thuoc-tinh/'.$id)
        ->with('mess', trans('admin.update_successfully')) ;
    }
