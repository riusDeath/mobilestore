...
class ProductController extends Controller
{
    ...
    public function createAtt(Request $request, $id)
    {
        ...
        return redirect('admin/san-pham/xem-thong-so-ky-thuat/'.$id)->with('mess', trans('admin.add_successfully')) ;
    ...
    public function addAtt(ProductAtributeRequest $request)
    {
        ...
        return redirect('admin/san-pham/thong-so-ky-thuat/')->with('mess', trans('admin.add_successfully')) ;
    ...
    public function updateAtt(ProductAtributeRequest $request,$id)
    {
        ...
        return redirect('admin/san-pham/sua-thuoc-tinh/'.$id)->with('mess', trans('admin.update_successfully')) ;
    }
