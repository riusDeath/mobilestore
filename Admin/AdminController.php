   ...
   public function index()
    ...
    public function update(UserRequest $request, $id)
    {
        ...
        if ($user = User::findOrFail($id)) {
            ...
            return redirect('admin/sua-thong-tin-admin/'.$id)->with('mess', trans('admin.update_successfully')) ;
        } 
    ...
    public function updateViews(UserRequest $request, $id)
    {
        ...
        return redirect('admin/danh-sach-admin')->with('mess', trans('admin.update_successfully')) ;
    }
