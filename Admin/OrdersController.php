...
class OrdersController extends Controller
{
    ...
    public function pay(PayRequest $request)
    {
        ...
        return redirect('admin/phuong-thuc-thanh-toan')->with('mess', trans('admin.add_successfully')) ;
    }
    ...
    public function newShip(ShipRequest $request)
    {
        ...
        return redirect('admin/phuong-thuc-giao-hang')->with('mess', trans('admin.update_successfully')) ;
    }
    ...
    public function updatePay(Request $request,$id)
    {
        ...
        return redirect('admin/phuong-thuc/sua-phuong-thuc-thanh-toan/'.$id)->with('mess', trans('admin.update_successfully')) ;
    ...
    public function updateShip( ShipRequest $request, $id)
    {
        ...
        return redirect('admin/phuong-thuc/sua-phuong-thuc-giao-hang/'.$id)->with('mess', trans('admin.update_successfully')) ;
    }
