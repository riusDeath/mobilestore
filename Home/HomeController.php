    ...
    public function cart(Request $request, $id)
    {
        ...
        if ($qty > 0) {
            ...
            if ($product->price_sale == 0) {
                Cart::add($id, $product->name, $qty,$product->price, ['image' => $product->image, 'options' => isset($request->color)?$request->color:0]);  
            } else {
                Cart::add($id, $product->name, $qty,$product->price_sale, ['image' => $product->image, 'options' => isset($request->color)?$request->color:0]);  
            }
